...
import backgroundAuthorImage from "../Images/Wallpaper_Home.jpg";
...
export default function About() {
    ...
    return (
        <main className="relative">
            <img src={backgroundAuthorImage} alt="Background Author Image" className="absolute w-full"/>
                ...
                <section className="bg-green-800 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className="text-lg flex-col justify-center">
                        ...
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent blocks={author.bio} prjectId="ft4es4yw" dataset="production" />
                        </div>
                    </div>
                </section>
            </div>
